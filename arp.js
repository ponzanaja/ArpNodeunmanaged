...
//////////////////////////////////  NEW SECTION ///////////////////////////////
  ...
  deviceNetwork.getSubtree({
    ...
    if (err) {
      ...
      sumInbound += inbound[16].inbound
      sumOutbound += outbound[16].outbound
  ...
  if (check) {
    ...
    setTimeout(() => {   
      let inb =  inbound[16].inbound
      let outb = outbound[16].outbound 
      let mainlinkData = {
        in: inb,
        out: outb
      }
    ...
    setTimeout(() => {  
    let sumInterface = intSpd[16].intSpd/1048576
